      ...
      body: RefreshIndicator(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              key: Key(swimPools[index].schwimmbadID.toString()), // Eindeutiger Schlüssel für das Listen-element
              direction: DismissDirection.horizontal, // Nur horizontale Wisch bewegungen erlauben
                  ...
                  return showDialog<bool>(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text('Möchten Sie dieses Element löschen?'),
                        actions: [
                          TextButton(
                            onPressed: () async {
                              final bool deleted = await deleteSwimPool(swimPools[index].schwimmbadID);
                              ...
                              Navigator.of(context).pop(deleted); // Benutzer hat "Ja" ausgewählt und schließt den Dialog sofort
                            },
                            child: const Text('Ja'),
                          ),
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).pop(false); // Benutzer hat "Nein" ausgewählt
                            },
                  ...
                  final bool editConfirmed = await showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text('Möchten Sie dieses Element bearbeiten?'),
                        actions: [
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).pop(false); // Benutzer hat "Nein" ausgewählt
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).pop(true); // Benutzer hat "Ja" ausgewählt
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => AddSwimPoolScreen(swimPool: swimPools[index]),
                                ),
                              );
                            },
                            child: const Text('Ja'),
