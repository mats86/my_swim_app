...
import 'package:my_swim_app/AddSwimCourseScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(swimCourse[index].courseDescription == null ? '': swimCourse[index].courseDescription!,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => const AddSwimCourseScreen()));
        },
