...
class _CustomerDashboardState extends State<CustomerDashboard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController.addListener(_updateFabVisibility); // Listener für Änderungen im TabController hinzufügen
  }
      ...
      body: Column(
        children: [
          ...
          TabBar(
            ...
            tabs: const [
              Tab(text: 'Gebuchte Kurse'),
              Tab(text: 'Abgeschlossene Kurse'),
              Tab(text: 'Profil'),
            ],
          ),
      ...
      children: [
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Kundeninformationen', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
...
List<Course> gebuchteKurse = [
  Course(name: 'Kurs 1', date: '01.09.2023', time: '10:00 Uhr', location: 'Ort 1'),
  Course(name: 'Kurs 2', date: '03.09.2023', time: '14:30 Uhr', location: 'Ort 2'),
  Course(name: 'Kurs 3', date: '05.09.2023', time: '09:15 Uhr', location: 'Ort 3'),
];

// Dummy-Werte für abgeschlossene Kurse
List<Course> abgeschlosseneKurse = [
  Course(name: 'Kurs A', date: '20.08.2023', time: '13:45 Uhr', location: 'Ort X'),
  Course(name: 'Kurs B', date: '25.08.2023', time: '16:30 Uhr', location: 'Ort Y'),
];
